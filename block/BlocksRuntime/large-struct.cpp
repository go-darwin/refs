...
static BobTheStruct __main_block_func_0(struct __main_block_impl_0 *__cself, BobTheStruct aBigStruct) {
...
int main(int argc, const char* argv[]) {
  ...
  copyStruct = ((BobTheStruct (*)(BobTheStruct))&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA));

  outty = ((BobTheStruct (*)(__block_impl *, BobTheStruct))((__block_impl *)copyStruct)->FuncPtr)((__block_impl *)copyStruct, inny);
