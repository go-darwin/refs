...
__attribute__((__visibility__("default"))) void * _NSConcreteStackBlock[32] = { 0 };
__attribute__((__visibility__("default"))) void * _NSConcreteGlobalBlock[32] = { 0 };


__attribute__((__visibility__("default"))) void * _NSConcreteMallocBlock[32] = { 0 };
__attribute__((__visibility__("default"))) void * _NSConcreteAutoBlock[32] = { 0 };
__attribute__((__visibility__("default"))) void * _NSConcreteFinalizingBlock[32] = { 0 };
__attribute__((__visibility__("default"))) void * _NSConcreteWeakBlockVariable[32] = { 0 };
