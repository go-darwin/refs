...
int main(int argc, char* argv[]) {
  __attribute__((__blocks__(byref))) __Block_byref_var_0 var = {(void*)0,(__Block_byref_var_0 *)&var, 0, sizeof(__Block_byref_var_0), 0};
  int shouldbe = 0;
  void (*b)(void) = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, (__Block_byref_var_0 *)&var, 570425344));
  void (^)() _b;
  ...
  for (i = 0; i < 10; i++) {
    _b = ((void (*)())_Block_copy((const void *)(b)));
    (__builtin_expect(!(_b), 0) ? __assert_rtn(__func__, "byrefcopycopy.m", 29, "_b") : (void)0);
    ++shouldbe;
    ((void (*)(__block_impl *))((__block_impl *)_b)->FuncPtr)((__block_impl *)_b);
    _Block_release((const void *)(_b));
  }
  ...
  if ((var.__forwarding->var) != shouldbe) {
    printf("Hmm, var is %d but should be %d\n", (var.__forwarding->var), shouldbe);
    return 1;
  }
  printf("%s: Success!!\n", argv[0]);
