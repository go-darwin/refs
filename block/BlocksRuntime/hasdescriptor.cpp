...
struct __main_block_impl_1 {
  ...
  struct __block_impl *inner;
  __main_block_impl_1(void *fp, struct __main_block_desc_1 *desc, void *_inner, int flags=0) : inner((struct __block_impl *)_inner) {
    impl.isa = &_NSConcreteStackBlock;
    impl.Flags = flags;
    impl.FuncPtr = fp;
    Desc = desc;
...
static void __main_block_func_1(struct __main_block_impl_1 *__cself) {
  void (*inner)() = (void (*)())__cself->inner; // bound by copy

    ((void (*)(__block_impl *))((__block_impl *)inner)->FuncPtr)((__block_impl *)inner);
    ((void (*)(__block_impl *))((__block_impl *)inner)->FuncPtr)((__block_impl *)inner);
  }
static void __main_block_copy_1(struct __main_block_impl_1*dst, struct __main_block_impl_1*src) {_Block_object_assign((void*)&dst->inner, (void*)src->inner, 7/*BLOCK_FIELD_IS_BLOCK*/);}

static void __main_block_dispose_1(struct __main_block_impl_1*src) {_Block_object_dispose((void*)src->inner, 7/*BLOCK_FIELD_IS_BLOCK*/);}
...
int main(int argc, char* argv[]) {
  void (*inner)(void) = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, argc));
  void (*outer)(void) = ((void (*)())&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA, (void *)inner, 570425344));
