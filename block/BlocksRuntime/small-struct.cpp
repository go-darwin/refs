...
static MiniStruct __main_block_func_0(struct __main_block_impl_0 *__cself, MiniStruct aTinyStruct) {
...
int main(int argc, const char* argv[]) {
  ...
  copyStruct = ((MiniStruct (*)(MiniStruct))&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA));

  outty = ((MiniStruct (*)(__block_impl *, MiniStruct))((__block_impl *)copyStruct)->FuncPtr)((__block_impl *)copyStruct, inny);
