...
void check(void (*b)(void)) {
  ...
  if (custom->innerp->isa != (void*)__null) {
...
int main(int argc, char* argv[]) {
  __attribute__((__blocks__(byref))) __Block_byref_i_0 i = {(void*)0,(__Block_byref_i_0 *)&i, 0, sizeof(__Block_byref_i_0)};
;

  check(((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, (__Block_byref_i_0 *)&i, 570425344)));
  printf("%s: success\n", argv[0]);
  return 0;
}
