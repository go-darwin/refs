...
struct __main_block_impl_1 {
  ...
  int d;
  struct stuff localStuff;
  __main_block_impl_1(void *fp, struct __main_block_desc_1 *desc, int _d, struct stuff _localStuff, int flags=0) : d(_d), localStuff(_localStuff) {
    impl.isa = &_NSConcreteStackBlock;
    impl.Flags = flags;
    impl.FuncPtr = fp;
    Desc = desc;
...
static void __main_block_func_1(struct __main_block_impl_1 *__cself) {
  int d = __cself->d; // bound by copy
  struct stuff localStuff = __cself->localStuff; // bound by copy

    printf("d is %d, localStuff.a is %lu", d, localStuff.a);
  }
...
int main(int argc, char* argv[]) {
  ...
  void (*a)(void) = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, d));
  void (*b)(void) = ((void (*)())&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA, d, localStuff));
