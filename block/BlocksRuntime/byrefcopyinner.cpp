...
struct __main_block_impl_1 {
  ...
  __Block_byref_a_0 *a; // by ref
  __main_block_impl_1(void *fp, struct __main_block_desc_1 *desc, __Block_byref_a_0 *_a, int flags=0) : a(_a->__forwarding) {
    impl.isa = &_NSConcreteStackBlock;
    impl.Flags = flags;
    impl.FuncPtr = fp;
    Desc = desc;
...
static void __main_block_func_1(struct __main_block_impl_1 *__cself) {
  __Block_byref_a_0 *a = __cself->a; // bound by ref
    ...
    ((void (*)())_Block_copy((const void *)(((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, (__Block_byref_a_0 *)a, 570425344)))));
...
int main(int argc, char* argv[]) {
  __attribute__((__blocks__(byref))) __Block_byref_a_0 a = {(void*)0,(__Block_byref_a_0 *)&a, 0, sizeof(__Block_byref_a_0), 42};
  int* ap = &(a.__forwarding->a);

  void (*b)(void) = ((void (*)())&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA, (__Block_byref_a_0 *)&a, 570425344));

  ((void (*)())_Block_copy((const void *)(b)));

  if (&(a.__forwarding->a) == ap) {
    printf(
