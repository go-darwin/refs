...
void callVoidVoid(void (*closure)(void)) { ((void (*)(__block_impl *))((__block_impl *)closure)->FuncPtr)((__block_impl *)closure); }
...
struct __main_block_impl_1 {
  ...
  int argc;
  int i;
  __main_block_impl_1(void *fp, struct __main_block_desc_1 *desc, int _argc, int _i, int flags=0) : argc(_argc), i(_i) {
    impl.isa = &_NSConcreteStackBlock;
    impl.Flags = flags;
    impl.FuncPtr = fp;
    Desc = desc;
...
static void __main_block_func_1(struct __main_block_impl_1 *__cself) {
  ...
  int i = __cself->i; // bound by copy
    ...
    if (argc > 0) {
      callVoidVoid(((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, i)));
    }
  }
...
int main(int argc, char* argv[]) {
  ...
  void (*vv)(void) = ((void (*)())&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA, argc, i));
