...
struct __main_block_impl_1 {
  ...
  int argc;
  struct __block_impl *intblock;
  __main_block_impl_1(void *fp, struct __main_block_desc_1 *desc, int _argc, void *_intblock, int flags=0) : argc(_argc), intblock((struct __block_impl *)_intblock) {
    impl.isa = &_NSConcreteStackBlock;
    impl.Flags = flags;
    impl.FuncPtr = fp;
    Desc = desc;
...
static void __main_block_func_1(struct __main_block_impl_1 *__cself) {
  ...
  int (*intblock)() = (int (*)())__cself->intblock; // bound by copy

    if (argc > 0) {
      printf("intblock returns %d\n", ((int (*)(__block_impl *))((__block_impl *)intblock)->FuncPtr)((__block_impl *)intblock));
    }
  }
static void __main_block_copy_1(struct __main_block_impl_1*dst, struct __main_block_impl_1*src) {_Block_object_assign((void*)&dst->intblock, (void*)src->intblock, 7/*BLOCK_FIELD_IS_BLOCK*/);}

static void __main_block_dispose_1(struct __main_block_impl_1*src) {_Block_object_dispose((void*)src->intblock, 7/*BLOCK_FIELD_IS_BLOCK*/);}
...
int main(int argc, char* argv[]) {
  int i = 1;
  int (*intblock)(void) = ((int (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, i));

  void (*vv)(void) = ((void (*)())&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA, argc, (void *)intblock, 570425344));
  ...
  void (*vvcopy)(void) = ((void (*)())_Block_copy((const void *)(vv)));
  _Block_release((const void *)(vvcopy));
  printf("%s: success\n", argv[0]);
  return 0;
}
