...
void callVoidVoid(voidVoid closure) { ((void (*)(__block_impl *))((__block_impl *)closure)->FuncPtr)((__block_impl *)closure); }

struct __Block_byref_dumbo_0 {
  void *__isa;
__Block_byref_dumbo_0 *__forwarding;
 int __flags;
 int __size;
 int dumbo;
};

struct __testRoutine_block_impl_0 {
  struct __block_impl impl;
  struct __testRoutine_block_desc_0* Desc;
  __Block_byref_dumbo_0 *dumbo; // by ref
  __testRoutine_block_impl_0(void *fp, struct __testRoutine_block_desc_0 *desc, __Block_byref_dumbo_0 *_dumbo, int flags=0) : dumbo(_dumbo->__forwarding) {
...
static void __testRoutine_block_func_0(struct __testRoutine_block_impl_0 *__cself) {
  __Block_byref_dumbo_0 *dumbo = __cself->dumbo; // bound by ref


    ++(dumbo->__forwarding->dumbo);
  }
static void __testRoutine_block_copy_0(struct __testRoutine_block_impl_0*dst, struct __testRoutine_block_impl_0*src) {_Block_object_assign((void*)&dst->dumbo, (void*)src->dumbo, 8/*BLOCK_FIELD_IS_BYREF*/);}

static void __testRoutine_block_dispose_0(struct __testRoutine_block_impl_0*src) {_Block_object_dispose((void*)src->dumbo, 8/*BLOCK_FIELD_IS_BYREF*/);}

static struct __testRoutine_block_desc_0 {
  size_t reserved;
  size_t Block_size;
  void (*copy)(struct __testRoutine_block_impl_0*, struct __testRoutine_block_impl_0*);
  void (*dispose)(struct __testRoutine_block_impl_0*);
} __testRoutine_block_desc_0_DATA = { 0, sizeof(struct __testRoutine_block_impl_0), __testRoutine_block_copy_0, __testRoutine_block_dispose_0};
voidVoid testRoutine(const char* whoami) {
  __attribute__((__blocks__(byref))) __Block_byref_dumbo_0 dumbo = {(void*)0,(__Block_byref_dumbo_0 *)&dumbo, 0, sizeof(__Block_byref_dumbo_0), strlen(whoami)};
  dummy = ((void (*)())&__testRoutine_block_impl_0((void *)__testRoutine_block_func_0, &__testRoutine_block_desc_0_DATA, (__Block_byref_dumbo_0 *)&dumbo, 570425344));

  voidVoid copy = ((voidVoid)_Block_copy((const void *)(dummy)));
...
int main(int argc, char* argv[]) {
  ...
  for (int i = 0; i < 100; ++i) {
    ...
    ((void (*)(__block_impl *))((__block_impl *)array[i])->FuncPtr)((__block_impl *)array[i]);
  }
  for (int i = 0; i < 100; ++i) {
    _Block_release((const void *)(array[i]));
  }
