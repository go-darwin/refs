...
struct __gblock_block_impl_0 {
  struct __block_impl impl;
  struct __gblock_block_desc_0* Desc;
  __gblock_block_impl_0(void *fp, struct __gblock_block_desc_0 *desc, int flags=0) {
...
static void __gblock_block_func_0(struct __gblock_block_impl_0 *__cself, int x) {

  global = x;
}

static struct __gblock_block_desc_0 {
  size_t reserved;
  size_t Block_size;
} __gblock_block_desc_0_DATA = { 0, sizeof(struct __gblock_block_impl_0)};
static __gblock_block_impl_0 __global_gblock_block_impl_0((void *)__gblock_block_func_0, &__gblock_block_desc_0_DATA);
void (*gblock)(int) = ((void (*)(int))&__global_gblock_block_impl_0);

int main(int argc, char* argv[]) {
  ((void (*)(__block_impl *, int))((__block_impl *)gblock)->FuncPtr)((__block_impl *)gblock, 1);
  if (global != 1) {
    printf("%s: *** did not set global to 1\n", argv[0]);
    return 1;
  }
  void (*gblockcopy)(int) = ((void (*)(int))_Block_copy((const void *)(gblock)));
  if (gblockcopy != gblock) {
    printf("global copy %p not a no-op %p\n", (void*)gblockcopy, (void*)gblock);
    return 1;
  }
  _Block_release((const void *)(gblockcopy));
  ((void (*)(__block_impl *, int))((__block_impl *)gblock)->FuncPtr)((__block_impl *)gblock, 3);
  if (global != 3) {
    printf("%s: *** did not set global to 3\n", argv[0]);
    return 1;
  }
  gblockcopy = ((void (*)(int))_Block_copy((const void *)(gblock)));
  ((void (*)(__block_impl *, int))((__block_impl *)gblockcopy)->FuncPtr)((__block_impl *)gblockcopy, 5);
  if (global != 5) {
