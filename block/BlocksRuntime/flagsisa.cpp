...
struct __Block_byref_flags_0 {
  void *__isa;
__Block_byref_flags_0 *__forwarding;
 int __flags;
 int __size;
 int flags;
};
struct __Block_byref_isa_1 {
  void *__isa;
__Block_byref_isa_1 *__forwarding;
 int __flags;
 int __size;
 void *isa;
};
...
struct __main_block_impl_0 {
  ...
  __Block_byref_flags_0 *flags; // by ref
  __Block_byref_isa_1 *isa; // by ref
  __main_block_impl_0(void *fp, struct __main_block_desc_0 *desc, __Block_byref_flags_0 *_flags, __Block_byref_isa_1 *_isa, int flags=0) : flags(_flags->__forwarding), isa(_isa->__forwarding) {
...
static void __main_block_func_0(struct __main_block_impl_0 *__cself) {
  __Block_byref_flags_0 *flags = __cself->flags; // bound by ref
  __Block_byref_isa_1 *isa = __cself->isa; // bound by ref

    (flags->__forwarding->flags) = 1;
    (isa->__forwarding->isa) = (void*)(isa->__forwarding->isa);
  }
static void __main_block_copy_0(struct __main_block_impl_0*dst, struct __main_block_impl_0*src) {_Block_object_assign((void*)&dst->flags, (void*)src->flags, 8/*BLOCK_FIELD_IS_BYREF*/);_Block_object_assign((void*)&dst->isa, (void*)src->isa, 8/*BLOCK_FIELD_IS_BYREF*/);}

static void __main_block_dispose_0(struct __main_block_impl_0*src) {_Block_object_dispose((void*)src->flags, 8/*BLOCK_FIELD_IS_BYREF*/);_Block_object_dispose((void*)src->isa, 8/*BLOCK_FIELD_IS_BYREF*/);}
...
int main(int argc, char* argv[]) {
  __attribute__((__blocks__(byref))) __Block_byref_flags_0 flags = {(void*)0,(__Block_byref_flags_0 *)&flags, 0, sizeof(__Block_byref_flags_0)};
;
  __attribute__((__blocks__(byref))) __Block_byref_isa_1 isa = {(void*)0,(__Block_byref_isa_1 *)&isa, 0, sizeof(__Block_byref_isa_1)};
;

  ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, (__Block_byref_flags_0 *)&flags, (__Block_byref_isa_1 *)&isa, 570425344));
  printf("%s: success\n", argv[0]);
  return 0;
}
