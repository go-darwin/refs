...
void dispatch_call_Block_with_release2(void* block) {
...
int main(int argc, char* argv[]) {
  void (*b1)(void) = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, argc));
  void (*b2)(void) = ((void (*)())&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA));

  dispatch_call_Block_with_release2(((void (*)())_Block_copy((const void *)(b1))));
  dispatch_call_Block_with_release2(((void (*)())_Block_copy((const void *)(b2))));
  printf("%s: Success\n", argv[0]);
  return 0;
}
