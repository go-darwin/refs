...
struct __global_block_impl_0 {
  struct __block_impl impl;
  struct __global_block_desc_0* Desc;
  __global_block_impl_0(void *fp, struct __global_block_desc_0 *desc, int flags=0) {
...
static void __global_block_func_0(struct __global_block_impl_0 *__cself) {

  printf("hello world\n");
}

static struct __global_block_desc_0 {
  size_t reserved;
  size_t Block_size;
} __global_block_desc_0_DATA = { 0, sizeof(struct __global_block_impl_0)};
static __global_block_impl_0 __global_global_block_impl_0((void *)__global_block_func_0, &__global_block_desc_0_DATA);
void (*global)(void) = ((void (*)())&__global_global_block_impl_0);
...
int main(int argc, char* argv[]) {
  int i = 10;
  void (*local)(void) = ((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, i));
  void (*localisglobal)(void) = ((void (*)())&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA));
