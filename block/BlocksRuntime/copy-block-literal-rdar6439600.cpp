...
int main(int argc, const char* argv[]) {
  ...
  for (i = 0; i < 100; i++)
    x[i] = ((int (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, i));

  for (i = 0; i < 100; i++) {
    if (((int (*)(__block_impl *))((__block_impl *)x[i])->FuncPtr)((__block_impl *)x[i]) != i) {
      printf("%s: failure, %d != %d\n", argv[0], ((int (*)(__block_impl *))((__block_impl *)x[i])->FuncPtr)((__block_impl *)x[i]), i);
      exit(1);
    }
  }
