...
static int (*)(long) __main_block_func_0(struct __main_block_impl_0 *__cself, char x) {
...
static int (*)(long) __main_block_func_1(struct __main_block_impl_1 *__cself, char x) {
 return funcptr; }
...
int main(int argc, char* argv[]) {
  ...
  b = ((int (*(*)(char))(long))&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA));

  b = ((int (*(*)(char))(long))&__main_block_impl_1((void *)__main_block_func_1, &__main_block_desc_1_DATA));
  printf("%s: Success\n", argv[0]);
  return 0;
}
